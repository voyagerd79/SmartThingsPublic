...
while i < len(services):
    t = services[i]
    print(t.std + " " + t.operator + " service from " + t.origin.location[0].locationName + " to " + t.destination.location[0].locationName + " - " + t.etd + " arriving at Platform " + str(t.platform))
    if t.etd != "On time":
        print(t.delayReason) 
    i += 1